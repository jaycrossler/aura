...
The early project bible **"Physics and Metaphysics Rulebook"** has been superseded by the
repo's universe-spec files, which are more detailed and current. Most of its content is
already canon under newer names. This file (1) maps the old vocabulary to current canon
so the bible can be retired without losing terminology, (2) folds in the genuinely
unique mechanics that have no repo home yet, and (3) flags the real conflicts.

Per [[spec_astral_phenomenology]], terminology is **intentionally loose** at story start
(different discoverers name things their own way). The old lexicon below is therefore
welcome as *in-world alternate vocabulary*, not a contradiction.

## Term Map (old bible → current canon)

| Old Rulebook term | Current canon | Notes |
|---|---|---|
| Kata Zero (Real Space) | Physical space / Kata Zero | "Kata Zero" usable as flavor lexicon. |
...
These had no repo home and are adopted (low conflict):
...
- **Sync-Crews / Choirs / Architects:** clustered human practitioners pooling Will into
  a lead Architect to move large mass. This is the *human* counterpart to humanity's
...
- 2026-06-17: New file. Folds the retired Physics & Metaphysics Rulebook bible: term map
  ...
  Hyperspace/Omega naming, explicit distance formulas).
