...
Life in the asteroid belt at story start operates under a specific scarcity regime: **abundant raw materials, scarce processed goods, scarce time-of-arrival.** Mars and Earth can fling enormous quantities of goods toward the belt — frozen food, manufactured components, coffee, books, medicine — but those shipments take months or years to arrive at any given station, and once committed cannot be redirected. Local manufacturing from local minerals is robust but slow and limited. Anything that arrives in days or hours is precious; anything that arrives in months or years can be planned around but not depended on for emergencies.
...
- **Volume.** Asteroids are big. Pressurized internal volume can be carved and lined as fast as the labor force will work.
- **Vacuum.** For materials science, manufacturing, certain biological processes, and waste disposal.
- **Solar power** (close to inner belt) and **nuclear power** (treaty-permitted past Mars). Energy is not the limiting factor.

## What Is Scarce

- **Specific processed goods.** Pharmaceuticals, advanced electronics, sealants, gaskets, seeds, breeding-stock animals, anything requiring an Earth or Mars supply chain.
- **Fresh food.** Hydroponics covers staples; variety is a luxury and arrives frozen on ferries.
- **Coffee and other consumable luxuries.** Genuinely scarce. Coffee is currency at small denominations.
- **Time-critical anything.** A medication that must arrive in 24 hours cannot be sourced from Mars. A skilled specialist who must arrive in 48 hours cannot be summoned. The belt either has the resource locally or does without.
- **Biological diversity.** Limited gene pool, limited microbiome, limited culinary plant variety.
- **Trained personnel.** Specific specialists are bottleneck resources. A station with one welder is fragile; a station with three is robust.
...
- **Information.** Abundant in volume, variable in reliability. (See [[tech_information_environment|The Information Environment (2105)]].)
...
The Origin time-cost pricing model is the dominant commercial expression of this scarcity, but it is not the cause. Origin is selling what the physics of the inner solar system already sells. (See [[faction_origin_industries|Origin Industries]].)
...
- **Not a dystopia of starvation.** Belters eat well, by their standards. The food is functional and nutritious. The luxury is in variety and freshness, not bare calories.
- **Not anti-tall.** Larger people exist and work in the belt; they cost more, but they bring proportional value when they're good at what they do. (Famous belt characters who break the size mold are deliberate exceptions and worth flagging.)
- **Not permanent.** As the belt's population grows, infrastructure matures, and local manufacturing diversifies, the scarcity regime softens. Books set later in the series can reflect a more comfortable belt without contradicting Book One's harshness.

## Open Questions

- Specific exchange rates. (How much is coffee worth in 2105 belt currency? How much labor does a kilogram of fresh tomato command? Worth pinning down for prose specificity.)
- Whether body-size hiring discrimination is regulated, taboo, or open in different stations.
- The cultural practices of specific stations — how does Fortuna's eating culture differ from Odysseus's?
- The point at which the scarcity regime visibly relaxes (probably mid-Book-Three or later).

## Cross-References

- [[location_fortuna_station|Fortuna Station]]
- [[faction_belter_stations|The Belter Stations]]
- [[faction_origin_industries|Origin Industries]] (the time-cost pricing model)
- [[tech_nuclear_ferries|Nuclear Ferry System]]
- [[tech_information_environment|The Information Environment (2105)]]
- [[char_jace_apollo|Jace Apollo Grant]] (size-as-disadvantage in the Origin negotiation)
