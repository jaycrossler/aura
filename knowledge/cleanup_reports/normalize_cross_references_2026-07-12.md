...
| `"[[char_nick_lee]]"` | `[[char_nick_lee]]` |
| `"[[char_jin_luong]]"` | `[[char_jin_luong]]` |
| `"[[technology/tech_seek_ai]]"` | `[[tech_seek_ai]]` |
| `"[[universe-spec/concept_aura_ai_system]]"` | `[[concept_aura_ai_system]]` |
...
- `arcs\arc_01_falcon_and_fortuna.md` → missing: `char_kim`, `char_torres`
- `arcs\arc_01_thread_A_arrival.md` → missing: `char_kim`, `char_torres`
- `arcs\arc_01_thread_L_life_texture.md` → missing: `char_kim`
- `arcs\arc_01_thread_S_swarm.md` → missing: `char_torres`, `char_kim`
