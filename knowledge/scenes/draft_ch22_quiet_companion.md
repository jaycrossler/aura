...
book: book01
chapter: Ch22
scene_contract: X-01b {Aura} installation, X-04e silver/copper survey, P-04 unlisted room ambiguity, L-07 Adama semantic gap, N-03 AI degradation
pov: char_jace_apollo
status: staged_draft
schema_version: 2
last_updated: 2026-08-19
description: >
  Jace recovers while the Victoria crew establishes new limits around {Misty},
  then he and Sophia test silver and copper in public areas of Fortuna. Nick and
  Lanchee install a local {Aura} instance under strict safety conditions. Its
  first bounded review connects contradictory outputs from Sparky, {Misty}, and
  {Seek}, finds two unresolved signatures in the Ring Three recordings, and
  verifies that an alarming message from Artemis arrived complete. Jace closes
  the chapter by placing an unexplained custom chip order.
cross_references:
...
Lanchee made the decision before he could pretend it was his. She sat him in the clinic with his stitched arm on a support, put three cups of water in front of him, and told him to order them by temperature.
...
Lanchee waited. She had already stitched the cut from Ring Three and scanned the bruise under his ribs. She knew the bar fight did not explain either wound. She also knew when two patients had rehearsed the same incomplete answer.
...
Lanchee took the cups away.

"No repeat exposure for twenty-four hours. No work outside normal duty. If sensation worsens, you come back. If either of you discovers the courage to tell me what treated him like prey, you come back sooner."

Jace started to stand.

"That was not permission to leave yet."

She checked his reflexes again.
...
"One encounter with a creature is not an exposure study," she said.

"It is one data point."

"It tried to reach into Sparky's light."

"A memorable data point."
...
{Misty} came back eleven hours after Jace touched her stack.
...
| Item | Status |
|---|---|
| Crossing debt carries into the following day as impaired temperature sensation | done |
| The Victoria crew establishes boundaries around {Misty}, and she authorizes a limited diagnostic export | done |
| Jace and Sophia survey silver and copper only in public station areas and avoid occupied rooms | done |
| Silver blocks Astral sight at ordinary thickness; copper dims it; the characters preserve the distinction between perceptual blocking and creature aversion | done |
| The Gold Horizon Inn mirror and a Foundry copper panel demonstrate the difference concretely | done |
| Jace and Sophia infer, without confirming, that someone could deliberately build an Astral-blind room | done |
| Nick references the Foundry's custom chip fabrication and retains his medical and station-risk reporting conditions | done |
...
| The {Aura} instance remains local and asks for content permission per data set | done |
| Raw sensor feeds remain separate before station normalization | done |
| {Aura} identifies two locally consistent coordinate sets and connects contradictory outputs across {Misty}, Sparky, and {Seek} without declaring a cause | done |
| {Aura} surfaces two unclassified signatures from the unlisted room as incomplete observations, not conclusions | done |
| Jace explicitly separates the unidentified room users from Jin's known crew | done |
| Artemis's intact message contains a semantic gap that {Aura} verifies did not result from transmission loss | done |
| Jace places an unexplained custom order matching the old Sparky chip footprint | done |
