...
This file is a working sketch of the early scenes of Book 1, capturing structural decisions and prompts for drafting. Not draft prose. Use this as a planning surface; promote material into proper `/scenes/` files as scenes get written.

---

## Pre-Story Backstory (Off-Page)
...
6. **The messages home.** Late evening. Family video calls — Dawn and Chris in Virginia, Athena at college. Failed call to Artemis at Adama. (`event_jace_messages_home.md`)
...
- See [[char_jace_apollo|Jace Apollo Grant]] for the full character arc the sequence services.
- See [[timeline_master|Master Timeline]] for chronological placement.
