...
notes: >
  Establishes: Jace as junior engineer, Thing One/Two workflow, Sparky project,
  Nick Lee as pre-arrival friend (shrinking comms lag), Saul remote oversight via
  voice notes, Maureen/printer arrangement, pig-cam social media beat, Cerberus
  dinner beat, first crystal dream, Day 3 alarm break.
---

# Chapter 1 — Afternoon Workshop (Draft)
...
Sparky — currently less a drone and more a philosophical position — occupied most of it. A partial frame, two mismatched sensor mounts, a motor housing that had printed slightly warped and needed to be redone. Again.

Nick had been specific, his voice arriving with a lag that was now closer to conversation than correspondence: *Mineral survey drone. Deep scan array, thermal tolerance for vacuum cycling, modular payload bay. This is what you need when you get here. Everything else you can buy.* Then, after a beat: *Also Screwdriver figured out the feeder latch again. You need to fix your pig.*

Screwdriver was not his pig. Screwdriver was her own pig. But he understood the sentiment.

He queued a reprint on the housing, adjusted the tolerance by half a millimeter, and hit start. The printer hummed to life.
...
Three hours on the housing. He could live with that.

Under the bench, Cerberus stirred, stretched both back legs to their full improbable length, and looked up at him with the focused intent of a dog who had thoughts about dinner.

"Yeah," Jace said. "Two minutes."

He saved the job, updated the queue — fourteen items, down from seventeen — and felt the small clean satisfaction of a man who had earned his three hours.
...
Rounds. Repairs. Sparky's motor housing came out clean this time, which felt like a small miracle and probably wasn't. He installed it, tested the rotor spin, and spent an hour arguing with the sensor mount tolerances while Nick's last message played in his head: *just print the bracket thicker, you're overthinking it.* Nick was, annoyingly, usually right. The lag between them was down to six minutes now — close enough that a back-and-forth almost felt like talking. Almost.
...
*[SCENE CONTINUES — Book 1 plumbing crisis / near-drowning event. To be drafted in next session.]*
