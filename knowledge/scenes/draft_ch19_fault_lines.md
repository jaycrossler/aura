...
book: book01
chapter: Ch19
scene_contract: X-04a interface lab, X-03b force recording, L-03 responsibility repair, N-00b apology without disclosure, P-04 movement restriction
...
description: >
  ...
  other side. Jace accidentally draws energy from Sophia, begins repairing his
  standing at Drone Ops, and ends the chapter facing new movement restrictions
  around the station leaseholds.
cross_references:
...
> *Apollo: What?*
>
> *Athena: The ruling Queen? Screwdriver the pig? How do you not know this? Your daring space rescue is like the intro background for the pig series. Cerberus and Siren help them with heists. Didn't you hear about the Goose rebellion? They were dive-bombing from on top the barn. Those suckers are mean.*
>
...
>
> *Apollo: No, of course not. It's an international station. Don't believe the news.*
...
She closed up again. "If it is a Chinese drone. Could be someone else's."
...
The distinction mattered because crossing was not remote viewing. Jace could see a little into the astral. Sometimes. And he couldn't control it. Sophia couldn't.
...
They crossed and put on the coats they kept there to manage the cold. They transferred the third camera.

He mounted all three cameras to Sparky's internal battery harness, so they could rotate and point in any direction. As they could see through his shell (and everything else, actually), Sparky didn't even need to open a panel to help with the pictures, but it did make images sharper.
...
"Zero? One? I am guessing when the numbers plateau, that is a good place to delineate it. Maybe it is like weightlifting?"
...
Jace wrote a card and pushed a card down into the real room.
...
This time Jace watched the camera displays while standing behind Sparky. One caught the central flare. One caught the plume wrapping around the cup. The third caught a branching wake that continued after the cup stopped moving.
...
Jace ripped off his radio and jacket, and returned to the Real faster than he ever had. He panicked the whole time. Was she okay?
...
"We still have experiments scheduled."
...
The battery and its controller passed through in six minutes.

Their previous best for a battery that size was eleven minutes.
...
They moved a gimbal, two motor housings, and a replacement battery shell. Every piece crossed double the expected speed. Jace felt no fatigue. The energy inside him remained full and steady. Sophia's handwriting became slower after each transfer.
...
He stopped, had her finish the coffee.

Sophia did not look at Jace. She kept writing, but he could feel the tension between her frustration at the time they had wasted and her fear of the energy he had taken. Life-force? Power? He did not know what to call it.
...
| Item | Status |
|---|---|
| Jace and Sophia rank safety, communication, imagery/recording, and physics in that order | done |
| The physical-to-Astral relay works through Morse vibration and Astral radio; paper remains the return path | done |
| Human crossings are explicitly full-body transfers; perception across the boundary is not partial bodily presence | done |
| Jace pushes for publication and Nick's involvement; Sophia refuses on scientific, privacy, and contractual grounds | done |
| Three incompatible camera projections are mounted on Sparky without producing a faithful four-dimensional reconstruction | done |
| The MRI/CT correlation idea is marked not ready pending medical reason, consent, privacy limits, and controls | done |
| Jace records Sophia's physical-space force with her canonical green-blue branching and gold-white working | done |
| Jace accidentally draws energy from Sophia and becomes alert while she becomes profoundly exhausted | done |
| Their energized push/pull transfers several Sparky components faster, but the gain is not advancement | done |
| Sophia withdraws from contact while Jace initially fails to understand the full harm | done |
| Jace completes an uneventful shift and begins regaining Kim and Carlos's trust | done |
| Jace sends Nick a sincere but structurally inadequate apology without disclosing the Astral | done |
| The Council movement restriction raises the stakes of any Ring Three investigation | done |
