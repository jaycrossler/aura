...
"These images will be famous. If we release at the right time, this will change everything. We need a full-time photographer."
...
For Sparky, Jace removed the panels and transferred them one at a time. Simpler metals crossed in minutes. The wires took longer. The controller took most of the session. He didn't even try to move the mini AI stack, even after one attempt he knew it would take days of pulling.
...
He had a coffee, using Tokens from the survey trip payout. His automations meant he could come in late.
...
*Hi, Contractor Grant! Your automated routing changes have produced several novel access patterns. I have added them to your existing Pattern of Interest file so we can learn together. No action is required. Have a productive shift. As an Origin employee on the station, I am required to alert you and {Alex} of this observation!*
...
They crossed, grabbed coats, started pulling. They had large air tanks now of air, and could quickly top off masks when they got low.
