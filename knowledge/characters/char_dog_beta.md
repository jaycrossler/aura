<!-- FILE: /knowledge/characters/char_dog_beta.md -->
---
# Identity
id: char_dog_beta
...
loyalties: [the Falcon crew broadly; later, the Fortuna Station livestock team]
...
character_arc: stable; gradually becomes the station's mascot
...
- **Body language:** Tail-up always, even when worried (unless something is genuinely wrong, which is the only time anyone has seen her tail go down). Body slams as greeting; jumps despite training; flops onto her back at the slightest invitation.
