...
gender: male
pronouns: he/him
date_of_birth: TBD (working — similar age to Maureen, 55-65)
birthplace: Haiti (working)
status: alive — recovering from surgery
first_appearance: Book 1 (remote presence during transit; in-person at Fortuna, later)
pov_character: false

# Affiliations
factions: [faction_origin_industries, faction_belter_stations]
loyalties: [char_maureen (wife), his work, quiet competence]

# Relationships
family: [char_maureen (wife)]
allies: [char_jace_apollo (mentor relationship — remote during transit, in-person at Fortuna)]

# Physical
appearance_summary: Old Haitian man. Weathered and calm. Moves with the unhurried confidence of someone who has fixed everything twice.
distinguishing_features: Always fiddling with something — a tool, a part, a problem. Rarely idle.

# Current Status (Book 1 Transit)
location: Mars — recovering from cancer surgery
condition: >
  Diagnosed with radiation-induced cancer — an occupational reality for long-haul belt
...
# Story Function
role_in_narrative: >
  Remote mentor figure during transit. His voice notes are a quiet through-line.
  His cancer grounds the story's hard-science reality — space is dangerous, careers
  are costly, the body keeps the score. At Fortuna (later books or late Book 1),
  he meets Jace in person and the mentorship becomes direct.
arc: Minor supporting character with thematic weight. Full arc TBD beyond Book 1 transit.
