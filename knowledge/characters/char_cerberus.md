...
date_of_death: alive
birthplace: Mars (U.S. settlement dog breeder facility — sub-facility within the agricultural / animal-husbandry division)
...
narratively_protected: true (never killed for plot, never seriously injured for plot — author commitment)

# Affiliations
factions: [bonded to char_jace_apollo; faction_belter_stations (de facto, post-Falcon arrival)]
loyalties: [Jace, his pack of one]
...
notable_traits: [strong skeletal frame for low-G, efficient respiration, low caloric demand for size, stable temperament, bred-out aggression, bred-out indiscriminate barking]
languages_understood: [English commands, eventually]
...
character_arc: helpless puppy → ship dog → belter dog; mirrors Jace's own arc of relocation and bonding; stable presence is the point
...
### As a Puppy (Mars breeder, early Falcon transit)
Tumbling, healthy, normal puppy behavior. Bonds easily. Already shows the breed-line traits: doesn't bark much even as a puppy, watches Jace's face with full attention, has a wrinkly little face that seems to express more than puppy faces usually do.
