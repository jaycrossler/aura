---
id: open_question_nick_crossing_resequence_v1
name: "Open Question - Immutable Nick Sheet After Chapter 23 Resequence"
type: review_queue
status: open
created: 2026-08-20
...
description: >
  ...
  without violating the repository's immutable-file rule.
cross_references:
  - "[[char_nick_lee]]"
...
# Immutable Nick Sheet Conflict After Chapter 23 Resequence
...
be edited during ordinary knowledge-bank maintenance:

- `knowledge/sheets/sheet_nick_arc01_end.md` says Nick crosses for ninety seconds
  during the swarm and relays coordinates from inside the Astral.
...
3. Preserve the conclusion that Nick will cross again only if a physical-side tool
   cannot meet the need.
4. Keep `[Information Flow]` nascent and unrecognized; Chapter 23 seeds it, and the
   swarm coordination reinforces it.
