...
/knowledge/build_tree.py             — Indexer script to rebuild tree index and validate KB
...
- **Index and Tree Management**: The index file `_index.md` is auto-generated by running `python build_tree.py` inside the `knowledge/` directory. Run this script whenever you add, delete, or modify files in the knowledge base to ensure the tree is correct and to check for warnings (drafts, orphans, sheet gaps).
