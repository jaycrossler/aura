...
/knowledge/generated_text/            — Generated plain-text files for audiobook review
...
- **Index, Tree, and Listening Text Management**: Run `python build_tree.py` inside the `knowledge/` directory whenever you add, delete, or modify knowledge files. The script rebuilds `_index.md`, checks warnings, and refreshes individual and five-chapter plain-text listening files under `generated_text/`.
