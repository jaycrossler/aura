...
type: agent_proposal
status: proposed
generated_at: '2026-04-30T01:38:19.164849+00:00'
...
- Add voice profile checks for `char_mei.md`.
- Add voice profile checks for `char_mr_sylvester.md`.
- Add voice profile checks for `char_sister_artemis.md`.
- Add voice profile checks for `char_sister_athena.md`.
- Add voice profile checks for `char_smuggler_mars.md`.